...
$.summernote = $.extend($.summernote, {
  ...
  options: {
    ...
    modules: {
      ...
      handle: Handle,
      // FIXME: HintPopover должен быть перед автолинком
      //  - Ошибка сценария о диапазоне при нажатии клавиши Enter на всплывающей подсказке
    ...
    // TODO: должны быть задокументированы
